 ...
 * v5.20.0: Distinct silhouettes · herb/stone Feinschliff per entry · stones with cut cues · color hue swatches ·
...
function defaultHerb() {
  return `${frameCircle()}
    <line x1="16" y1="26" x2="16" y2="10" stroke="${SAGE}" stroke-width="1.35"/>
    ${leafSimple(11.5, 14, -42, GREEN, 8)}
    ${leafSimple(20.5, 14, 42, GREEN, 8)}
    ${leafSimple(12.5, 19, -38, SAGE, 6.5)}
    ${leafSimple(19.5, 19, 38, SAGE, 6.5)}
    <circle cx="16" cy="9" r="1.4" fill="${GOLD}" fill-opacity="0.45"/>`;
}
...
function defaultStone() {
  return `${frameCircle()}
    <ellipse cx="16" cy="17" rx="9" ry="7.2" fill="${TEAL}" fill-opacity="0.55" stroke="${STROKE}" stroke-width="1"/>
    <path d="M9 15 Q16 10 23 15" fill="none" stroke="${CREAM}" stroke-opacity="0.4" stroke-width="0.8"/>
    <circle cx="13" cy="16" r="1.2" fill="${CREAM}" fill-opacity="0.35"/>`;
}
...
const NAME_MOTIF = {
  ...
  'Minze': () => `${frameCircle()}<line x1="16" y1="26" x2="16" y2="9" stroke="${SAGE}" stroke-width="1.25"/>${leafSimple(11.5, 14, -48, GREEN, 7.5)}${leafSimple(20.5, 14, 48, GREEN, 7.5)}${leafSimple(12, 19, -42, SAGE, 6)}${leafSimple(20, 19, 42, SAGE, 6)}<path d="M16 12 Q13 11 12 9 M16 12 Q19 11 20 9" fill="none" stroke="${CREAM}" stroke-opacity="0.4" stroke-width="0.6"/>`,
  'Kamille': () => daisy(),
  'Basilikum': () => `${frameCircle()}<path d="M16 26 C9 18 9 11 16 5 C23 11 23 18 16 26Z" fill="${GREEN}" fill-opacity="0.88"/><path d="M16 24 V7" stroke="${CREAM}" stroke-opacity="0.4" stroke-width="0.7"/><path d="M16 12 Q11 14 10 17 M16 14 Q21 16 22 19" fill="none" stroke="${SAGE}" stroke-opacity="0.55" stroke-width="0.7"/>`,
  'Lorbeer': () => `${frameCircle()}<ellipse cx="11" cy="15" rx="5.5" ry="9" transform="rotate(-28 11 15)" fill="${SAGE}" fill-opacity="0.85"/><ellipse cx="21" cy="15" rx="5.5" ry="9" transform="rotate(28 21 15)" fill="${GREEN}" fill-opacity="0.8"/><path d="M11 8 Q16 16 11 23 M21 8 Q16 16 21 23" fill="none" stroke="${CREAM}" stroke-opacity="0.35" stroke-width="0.6"/><circle cx="16" cy="15" r="2.2" fill="${GOLD}" fill-opacity="0.55"/>`,
  'Beifuß': () => mugwortLeaf(),
  ...
  'Oregano': () => `${frameCircle()}<line x1="16" y1="26" x2="16" y2="8" stroke="${SAGE}" stroke-width="1.2"/><ellipse cx="12.5" cy="11" rx="3.2" ry="1.6" fill="${GREEN}" fill-opacity="0.85"/><ellipse cx="19.5" cy="12" rx="3.2" ry="1.6" fill="${SAGE}" fill-opacity="0.85"/><ellipse cx="12.5" cy="15" rx="3.2" ry="1.6" fill="${GREEN}" fill-opacity="0.85"/><ellipse cx="19.5" cy="16" rx="3.2" ry="1.6" fill="${SAGE}" fill-opacity="0.85"/><ellipse cx="12.5" cy="19" rx="3.2" ry="1.6" fill="${GREEN}" fill-opacity="0.85"/><ellipse cx="19.5" cy="20" rx="3.2" ry="1.6" fill="${SAGE}" fill-opacity="0.85"/>`,
  'Petersilie': () => `${frameCircle()}<line x1="16" y1="26" x2="16" y2="14" stroke="${SAGE}" stroke-width="1.15"/><path d="M16 14 Q10 10 8 8" fill="none" stroke="${GREEN}" stroke-width="1.4" stroke-linecap="round"/><circle cx="8" cy="8" r="2.1" fill="${GREEN}" fill-opacity="0.85"/><path d="M16 14 Q16 9 16 7" fill="none" stroke="${GREEN}" stroke-width="1.4" stroke-linecap="round"/><circle cx="16" cy="7" r="2.2" fill="${GREEN}" fill-opacity="0.85"/><path d="M16 14 Q22 10 24 8" fill="none" stroke="${GREEN}" stroke-width="1.4" stroke-linecap="round"/><circle cx="24" cy="8" r="2.1" fill="${GREEN}" fill-opacity="0.85"/>`,
  'Frauenmantel': () => `${frameCircle()}<path d="M16 24 C8 18 7 11 16 6 C25 11 24 18 16 24Z" fill="${GREEN}" fill-opacity="0.8"/><path d="M10 14 Q16 18 22 14" fill="none" stroke="${CREAM}" stroke-opacity="0.45" stroke-width="0.8"/><circle cx="16" cy="12" r="1.5" fill="${CREAM}" fill-opacity="0.4"/>`,
  'Gänseblümchen': () => daisy(),
  ...
  'Hopfen': () => hopCone(),
  'Baldrian': () => `${frameCircle()}<path d="M16 26 C10 20 8 14 16 7 C24 14 22 20 16 26Z" fill="${PURPLE}" fill-opacity="0.55"/><path d="M10 18 Q16 22 22 18" fill="none" stroke="${PURPLE}" stroke-width="1.2"/><circle cx="12" cy="12" r="2" fill="${CREAM}" fill-opacity="0.45"/><circle cx="20" cy="12" r="2" fill="${CREAM}" fill-opacity="0.45"/><circle cx="16" cy="9" r="2.3" fill="${GOLD}" fill-opacity="0.4"/>`,
  'Eibisch': () => `${frameCircle()}<path d="M16 25 C8 17 9 10 16 5 C23 10 24 17 16 25Z" fill="${ROSE}" fill-opacity="0.72"/><circle cx="16" cy="13" r="3.2" fill="${CREAM}" fill-opacity="0.55"/><circle cx="16" cy="13" r="1.3" fill="${GOLD}" fill-opacity="0.5"/>${leafSimple(9,20,-55,GREEN,5.5)}${leafSimple(23,20,55,GREEN,5.5)}`,
  'Birke': () => birch(),
  'Weide': () => `${frameCircle()}<line x1="16" y1="26" x2="16" y2="8" stroke="#8a6a3a" stroke-width="1.4"/><path d="M16 10 Q8 14 7 22 M16 10 Q24 14 25 22 M16 12 Q10 16 10 24 M16 12 Q22 16 22 24" fill="none" stroke="${GREEN}" stroke-width="1.1" stroke-linecap="round"/>`,
  'Fichte': () => treeNeedle(),
  'Eichenblatt': () => oakLeaf(),
  'Myrte': () => `${frameCircle()}<ellipse cx="12" cy="13" rx="4" ry="7" transform="rotate(-32 12 13)" fill="${GREEN}" fill-opacity="0.85"/><ellipse cx="20" cy="13" rx="4" ry="7" transform="rotate(32 20 13)" fill="${SAGE}" fill-opacity="0.85"/><ellipse cx="16" cy="16" rx="3.5" ry="6" fill="${GREEN}" fill-opacity="0.7"/><circle cx="16" cy="22" r="2.4" fill="${CREAM}" fill-opacity="0.65"/><circle cx="16" cy="22" r="1" fill="${GOLD}" fill-opacity="0.45"/>`,
  'Tabak (symbolisch)': () => `${frameCircle()}<path d="M8 22 Q16 6 24 22" fill="#8a6a3a" fill-opacity="0.75" stroke="#6a4a28" stroke-width="0.8"/><path d="M16 22 V9" stroke="#c4a060" stroke-opacity="0.5" stroke-width="0.7"/><path d="M12 16 Q16 14 20 16" fill="none" stroke="#c4a060" stroke-opacity="0.35" stroke-width="0.6"/>`,
  'Tabak (Symbol)': () => `${frameCircle()}<path d="M8 22 Q16 6 24 22" fill="#8a6a3a" fill-opacity="0.75" stroke="#6a4a28" stroke-width="0.8"/><path d="M16 22 V9" stroke="#c4a060" stroke-opacity="0.5" stroke-width="0.7"/><path d="M12 16 Q16 14 20 16" fill="none" stroke="#c4a060" stroke-opacity="0.35" stroke-width="0.6"/>`,

  // Kitchen
  'Salz': () => `${frameCircle()}<rect x="10" y="10" width="12" height="14" rx="1.5" fill="${CREAM}" fill-opacity="0.55" stroke="${STROKE}" stroke-width="0.9"/><path d="M13 14 L15 18 L17 14 L19 18" fill="none" stroke="${GOLD}" stroke-opacity="0.5" stroke-width="0.8"/><circle cx="14" cy="21" r="0.8" fill="${CREAM}"/><circle cx="18" cy="20" r="0.7" fill="${CREAM}"/>`,
  'Zucker': () => `${frameCircle()}<path d="M10 22 L12 10 H20 L22 22Z" fill="#fff8e8" fill-opacity="0.75" stroke="${GOLD}" stroke-width="0.9"/><circle cx="14" cy="15" r="1" fill="${GOLD}" fill-opacity="0.35"/><circle cx="18" cy="17" r="0.9" fill="${GOLD}" fill-opacity="0.35"/><circle cx="16" cy="20" r="0.8" fill="${GOLD}" fill-opacity="0.3"/>`,
  'Zimt': () => `${frameCircle()}<rect x="11" y="7" width="4.2" height="18" rx="1.2" fill="#8a4a28" fill-opacity="0.85"/><rect x="16.5" y="9" width="4.2" height="16" rx="1.2" fill="#a05a32" fill-opacity="0.8"/><path d="M13 10 Q15 16 13 22 M18.5 12 Q20.5 17 18.5 22" fill="none" stroke="${GOLD}" stroke-opacity="0.35" stroke-width="0.6"/>`,
  'Honig': () => honey(),
  'Öl': () => oilDrop(),
  'Essig': () => jar(),
  'Milch': () => milk(),
  'Ei': () => egg(),
  'Brot': () => bread(),
  'Pfeffer': () => `${frameCircle()}<circle cx="12" cy="14" r="3.2" fill="#2a2a28" fill-opacity="0.85"/><circle cx="20" cy="13" r="2.8" fill="#3a2a22" fill-opacity="0.85"/><circle cx="16" cy="19" r="3" fill="#2a2218" fill-opacity="0.9"/><circle cx="14" cy="12" r="0.6" fill="${CREAM}" fill-opacity="0.35"/>`,
  'Knoblauch': () => garlic(),
  'Nelke': () => `${frameCircle()}<circle cx="16" cy="14" r="5.5" fill="#6a2a3a" fill-opacity="0.8"/><path d="M16 8 L17.5 13 L22 12 L18.5 15.5 L21 20 L16 17.5 L11 20 L13.5 15.5 L10 12 L14.5 13Z" fill="#a04050" fill-opacity="0.85"/><line x1="16" y1="20" x2="16" y2="26" stroke="${SAGE}" stroke-width="1.2"/>`,
  ...
  'Kardamom': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="5" ry="9" fill="#4a7a4a" fill-opacity="0.75" stroke="${SAGE}" stroke-width="0.9"/><path d="M16 7 V25 M13 12 Q16 14 19 12 M13 18 Q16 20 19 18" fill="none" stroke="${CREAM}" stroke-opacity="0.4" stroke-width="0.65"/>`,
  'Vanille': () => `${frameCircle()}<path d="M12 6 Q10 16 13 26 M16 5 Q15 16 17 26 M20 6 Q22 16 19 26" fill="none" stroke="#c4a060" stroke-width="1.6" stroke-linecap="round"/><circle cx="13" cy="12" r="0.8" fill="#5a3a18"/><circle cx="17" cy="15" r="0.8" fill="#5a3a18"/><circle cx="19" cy="11" r="0.7" fill="#5a3a18"/>`,
  'Senf': () => `${frameCircle()}<ellipse cx="16" cy="18" rx="8" ry="6" fill="#e8d060" fill-opacity="0.7" stroke="#c4a030" stroke-width="0.9"/><circle cx="12" cy="12" r="2.2" fill="#d4b040" fill-opacity="0.8"/><circle cx="18" cy="11" r="2" fill="#e8c040" fill-opacity="0.8"/><circle cx="16" cy="14" r="1.8" fill="#c4a020" fill-opacity="0.75"/>`,
  'Kaffee': () => coffee(),
  ...
  'Butter': () => `${frameCircle()}<rect x="8" y="12" width="16" height="10" rx="1.5" fill="#e8d060" fill-opacity="0.8" stroke="#c4a030" stroke-width="0.9"/><rect x="10" y="10" width="12" height="3" rx="0.8" fill="#f0e080" fill-opacity="0.7"/>`,
  'Seife': () => soap(),
  'Wasser': () => water(),
  'Zitrone': () => lemon(),
  'Ingwer': () => `${frameCircle()}<path d="M7 18 Q10 10 14 12 Q16 8 20 10 Q24 12 25 18 Q22 24 16 23 Q10 24 7 18Z" fill="#c4893a" fill-opacity="0.8" stroke="#8a5a28" stroke-width="0.9"/><path d="M12 14 Q16 16 20 13" fill="none" stroke="${CREAM}" stroke-opacity="0.35" stroke-width="0.7"/>`,
  ...
  'Obst': () => `${frameCircle()}<circle cx="13" cy="17" r="5.5" fill="#c43c3c" fill-opacity="0.75"/><circle cx="20" cy="15" r="4.5" fill="#d4782a" fill-opacity="0.7"/><path d="M16 10 Q16 7 14 6" fill="none" stroke="${GREEN}" stroke-width="1.2"/><ellipse cx="17" cy="9" rx="2.5" ry="1.2" fill="${GREEN}" fill-opacity="0.8"/>`,
  'Blumen': () => daisy(),
  ...
  'Süßes': () => `${frameCircle()}<rect x="9" y="14" width="14" height="9" rx="2" fill="#d490a8" fill-opacity="0.7" stroke="#a06080" stroke-width="0.9"/><path d="M11 14 Q16 8 21 14" fill="#e8b0c0" fill-opacity="0.7" stroke="#a06080" stroke-width="0.7"/><circle cx="16" cy="18" r="1.5" fill="${GOLD}" fill-opacity="0.45"/>`,
  'Kerze': () => wax(),
  'Licht': () => sunHerb(),
  'Rauch': () => smoke(),
  'Münze': () => coin(),
  'Alkohol': () => wineGlass('#6a4a8a'),
  'Rum': () => `${frameCircle()}<path d="M12 7 H20 V11 H12Z" fill="#6a3a22" fill-opacity="0.6"/><rect x="11" y="11" width="10" height="13" rx="1" fill="#8a4a28" fill-opacity="0.7" stroke="#6a3a22" stroke-width="0.9"/><line x1="13" y1="15" x2="19" y2="15" stroke="${GOLD}" stroke-opacity="0.4" stroke-width="0.7"/>`,
  'Wein': () => wineGlass('#6a1a2a'),
  'Rotwein': () => wineGlass('#7a1e2e'),
  'Weißwein': () => wineGlass('#e8d890'),
  'Bier': () => beerMug(),
  'Met': () => `${frameCircle()}<path d="M10 10 H22 L20 24 H12Z" fill="#e8c040" fill-opacity="0.55" stroke="#c4a030" stroke-width="1"/><ellipse cx="16" cy="10" rx="6" ry="2" fill="#f0d060" fill-opacity="0.5"/><circle cx="14" cy="16" r="1" fill="${GOLD}" fill-opacity="0.4"/><circle cx="18" cy="19" r="0.9" fill="${GOLD}" fill-opacity="0.35"/>`,
  'Schnaps': () => `${frameCircle()}<path d="M12 8 H20 L19 12 H13Z" fill="${CREAM}" fill-opacity="0.4" stroke="${STROKE}" stroke-width="0.8"/><rect x="11" y="12" width="10" height="12" rx="1" fill="#c4c8d0" fill-opacity="0.45" stroke="${STROKE}" stroke-width="0.9"/><line x1="13" y1="16" x2="19" y2="16" stroke="${GOLD}" stroke-opacity="0.4" stroke-width="0.7"/>`,
  'Branntwein': () => jar(),
  'Whisky': () => `${frameCircle()}<path d="M11 8 H21 L20 12 H12Z" fill="#c4893a" fill-opacity="0.5" stroke="#8a5a28" stroke-width="0.8"/><rect x="10" y="12" width="12" height="12" rx="1" fill="#a06a32" fill-opacity="0.65" stroke="#8a5a28" stroke-width="0.9"/><ellipse cx="16" cy="18" rx="3" ry="1.2" fill="${GOLD}" fill-opacity="0.35"/>`,
  ...
  // Stones
  'Bergkristall': () => `${frameCircle()}<path d="M16 4 L25 13 L21 27 L11 27 L7 13Z" fill="#e8f0f8" fill-opacity="0.35" stroke="#b0c0d0" stroke-width="1"/><path d="M16 4 V27 M9 13 H23" stroke="${CREAM}" stroke-opacity="0.5" stroke-width="0.7"/>`,
  'Rosenquarz': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#d490a8" fill-opacity="0.55" stroke="#a06080" stroke-width="1"/><path d="M10 14 Q16 10 22 15" fill="none" stroke="${CREAM}" stroke-opacity="0.45" stroke-width="0.9"/><circle cx="14" cy="17" r="1.3" fill="${CREAM}" fill-opacity="0.35"/>`,
  'Rauchquarz': () => `${frameCircle()}<path d="M16 5 L24 14 L20 26 L12 26 L8 14Z" fill="#5a4a42" fill-opacity="0.7" stroke="#3a2a22" stroke-width="1"/><path d="M16 5 V26" stroke="${CREAM}" stroke-opacity="0.3" stroke-width="0.7"/>`,
  'Raucherquarz': () => `${frameCircle()}<path d="M16 5 L24 14 L20 26 L12 26 L8 14Z" fill="#5a4a42" fill-opacity="0.7" stroke="#3a2a22" stroke-width="1"/><path d="M16 5 V26" stroke="${CREAM}" stroke-opacity="0.3" stroke-width="0.7"/>`,
  'Amethyst': () => `${frameCircle()}<path d="M16 5 L24 14 L20 26 L12 26 L8 14Z" fill="#7a4aaa" fill-opacity="0.7" stroke="#5a2a8a" stroke-width="1"/><path d="M16 5 V26 M10 14 H22" stroke="${CREAM}" stroke-opacity="0.3" stroke-width="0.65"/><circle cx="16" cy="14" r="1.5" fill="${GOLD}" fill-opacity="0.35"/>`,
  'Citrin': () => `${frameCircle()}<path d="M16 5 L24 14 L20 26 L12 26 L8 14Z" fill="#e8c040" fill-opacity="0.7" stroke="#c4a030" stroke-width="1"/><path d="M16 5 V26" stroke="${CREAM}" stroke-opacity="0.35" stroke-width="0.7"/>`,
  'Milchquarz': () => `${frameCircle()}<path d="M16 5 L24 14 L20 25 L12 25 L8 14Z" fill="#e8e4f0" fill-opacity="0.75" stroke="#b0a8c0" stroke-width="0.9"/><path d="M16 5 V25 M10 14 H22" stroke="${CREAM}" stroke-opacity="0.45" stroke-width="0.65"/>`,
  'Aventurin': () => cabochon('#5a9a6a'),
  'Obsidian': () => `${frameCircle()}<path d="M8 18 L16 5 L24 18 L20 26 L12 26Z" fill="#1a1a22" fill-opacity="0.9" stroke="#4a4a52" stroke-width="1"/><path d="M12 14 L18 20" stroke="${CREAM}" stroke-opacity="0.35" stroke-width="0.9"/>`,
  'Schwarzer Turmalin': () => `${frameCircle()}<path d="M14 5 L18 5 L21 26 L11 26Z" fill="#1a1a22" fill-opacity="0.9" stroke="#4a4a52" stroke-width="1"/><path d="M15 8 L17 8 M13 16 L19 16 M12 22 L20 22" stroke="${CREAM}" stroke-opacity="0.25" stroke-width="0.6"/>`,
  'Schwarzer Turmalin (Symbol)': () => crystalDark('#2a2a35'),
  'Hämatit': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#4a3a3a" fill-opacity="0.85" stroke="#8a6a6a" stroke-width="1"/><path d="M10 13 H22" stroke="#c0a0a0" stroke-opacity="0.45" stroke-width="1"/><circle cx="14" cy="17" r="1.2" fill="#e0c0c0" fill-opacity="0.35"/>`,
  'Onyx': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#1a1a22" fill-opacity="0.9" stroke="#6a6a72" stroke-width="1"/><ellipse cx="16" cy="16" rx="5" ry="4.5" fill="none" stroke="#c0c0c8" stroke-opacity="0.35" stroke-width="1.1"/><path d="M10 14 H22" stroke="#888" stroke-opacity="0.4" stroke-width="0.7"/>`,
  'Labradorit': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#2a3a4a" fill-opacity="0.75" stroke="#4a6a7a" stroke-width="1"/><path d="M9 18 Q14 10 20 14 Q24 17 23 12" fill="none" stroke="#40e0c0" stroke-opacity="0.55" stroke-width="1.2"/><path d="M10 14 Q16 20 22 13" fill="none" stroke="#7aa8c9" stroke-opacity="0.4" stroke-width="0.8"/>`,
  'Mondstein': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#d0d8e0" fill-opacity="0.65" stroke="#a0a8b0" stroke-width="1"/><circle cx="13" cy="13" r="3" fill="${CREAM}" fill-opacity="0.45"/><path d="M10 20 Q16 22 22 18" fill="none" stroke="${CREAM}" stroke-opacity="0.35" stroke-width="0.8"/>`,
  ...
  'Jaspis': () => `${frameCircle()}<path d="M8 20 Q10 8 16 7 Q22 8 24 20 Q20 25 16 25 Q12 25 8 20Z" fill="#a84a3a" fill-opacity="0.7" stroke="#8a3a2a" stroke-width="0.9"/><path d="M11 12 Q16 16 21 12 M12 17 Q16 20 20 17" fill="none" stroke="#e8c0a0" stroke-opacity="0.4" stroke-width="0.7"/>`,
  'Achat': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#8a6a4a" fill-opacity="0.55" stroke="${STROKE}" stroke-width="1"/><ellipse cx="16" cy="16" rx="6" ry="5" fill="none" stroke="#c4a060" stroke-opacity="0.5" stroke-width="1"/><ellipse cx="16" cy="16" rx="3" ry="2.5" fill="none" stroke="#e8d0a0" stroke-opacity="0.4" stroke-width="0.8"/>`,
  'Moosachat': () => `${frameCircle()}<circle cx="16" cy="16" r="9" fill="#4a7a5a" fill-opacity="0.45" stroke="${GREEN}" stroke-width="1"/>${leafSimple(14,14,-20,GREEN,5)}${leafSimple(19,17,30,SAGE,4)}<circle cx="12" cy="19" r="1.5" fill="${GREEN}" fill-opacity="0.5"/>`,
  'Tigerauge': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#8a5a22" fill-opacity="0.75" stroke="#6a3a12" stroke-width="1"/><path d="M8 14 H24 M8 18 H24 M10 11 H22" stroke="#e8c040" stroke-opacity="0.45" stroke-width="0.9"/>`,
  'Karneol': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#c45a3a" fill-opacity="0.75" stroke="#8a3a2a" stroke-width="1"/><path d="M10 14 Q16 10 22 15" fill="none" stroke="${GOLD}" stroke-opacity="0.4" stroke-width="0.9"/><circle cx="13" cy="17" r="1.2" fill="${CREAM}" fill-opacity="0.3"/>`,
  ...
  'Fluorit': () => `${frameCircle()}<path d="M16 6 L24 12 L24 20 L16 26 L8 20 L8 12Z" fill="#7a4aaa" fill-opacity="0.45" stroke="#9a6aca" stroke-width="1"/><path d="M16 6 V26 M8 12 H24 M8 20 H24" stroke="#40e0c0" stroke-opacity="0.35" stroke-width="0.7"/>`,
  ...
  'Jade': () => `${frameCircle()}<path d="M7 18 Q10 8 16 7 Q22 8 25 18 Q22 24 16 25 Q10 24 7 18Z" fill="#3a8a5a" fill-opacity="0.7" stroke="#2a6a42" stroke-width="0.9"/><path d="M11 14 Q16 11 21 14" fill="none" stroke="${CREAM}" stroke-opacity="0.4" stroke-width="0.7"/><circle cx="14" cy="16" r="1.1" fill="${CREAM}" fill-opacity="0.35"/>`,
  'Türkis': () => cabochon('#3aa8a8'),
  'Malachit': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#2a7a4a" fill-opacity="0.7" stroke="#1a5a32" stroke-width="1"/><path d="M9 16 Q16 8 23 16 Q16 24 9 16" fill="none" stroke="#6aba7a" stroke-width="1.2"/><path d="M11 16 Q16 11 21 16" fill="none" stroke="#a0d0a8" stroke-opacity="0.45" stroke-width="0.8"/>`,
  'Granat': () => `${frameCircle()}<path d="M16 6 L22 12 L20 22 L12 22 L10 12Z" fill="#8a1a2a" fill-opacity="0.8" stroke="#c04050" stroke-width="0.9"/><path d="M16 6 V22 M10 12 H22" stroke="${CREAM}" stroke-opacity="0.25" stroke-width="0.6"/>`,
  'Flint': () => `${frameCircle()}<path d="M8 20 L14 6 L24 14 L20 25 L10 24Z" fill="#4a4a52" fill-opacity="0.85" stroke="#8a8a96" stroke-width="0.9"/><path d="M14 6 L18 16 L10 24" fill="none" stroke="${CREAM}" stroke-opacity="0.35" stroke-width="0.7"/>`,
  'Flusskiesel': () => `${frameCircle()}<ellipse cx="13" cy="18" rx="6" ry="4.5" fill="#7a8a8a" fill-opacity="0.65"/><ellipse cx="20" cy="15" rx="5.5" ry="4" fill="#9aa4a8" fill-opacity="0.7"/><ellipse cx="16" cy="12" rx="4.5" ry="3.2" fill="#b0b8b8" fill-opacity="0.55" stroke="${STROKE}" stroke-width="0.6"/>`,
  'Sodalith': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#2a3a8a" fill-opacity="0.75" stroke="#4a6aaa" stroke-width="1"/><path d="M9 13 Q14 10 18 14 Q22 18 24 15" fill="none" stroke="${CREAM}" stroke-opacity="0.45" stroke-width="0.9"/><circle cx="12" cy="18" r="1.3" fill="${CREAM}" fill-opacity="0.3"/>`,
  ...
  'Knochenweiß-Stein': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="7" fill="#e8e0d0" fill-opacity="0.8" stroke="#c4b8a0" stroke-width="1"/><path d="M9 16 H23 M16 10 V22" stroke="#c4b8a0" stroke-opacity="0.45" stroke-width="0.7"/>`,
  'Eisengrau-Stein': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#5a5a62" fill-opacity="0.75" stroke="#8a8a96" stroke-width="1"/><path d="M10 13 H22 M12 18 H20" stroke="#a0a0a8" stroke-opacity="0.4" stroke-width="0.8"/>`,
  ...
  'Kiesel vom Weg': () => `${frameCircle()}<ellipse cx="12" cy="17" rx="5.5" ry="4" fill="#8a7a5a" fill-opacity="0.7"/><ellipse cx="20" cy="16" rx="5" ry="4.2" fill="#6a5a42" fill-opacity="0.75"/><ellipse cx="16" cy="13" rx="4" ry="3" fill="#a09070" fill-opacity="0.55"/>`,
  'Tonperle': () => `${frameCircle()}<circle cx="16" cy="16" r="8" fill="#a87848" fill-opacity="0.75" stroke="#8a5a32" stroke-width="1"/><circle cx="16" cy="16" r="2.2" fill="none" stroke="${CREAM}" stroke-opacity="0.5" stroke-width="1"/><circle cx="13" cy="13" r="1" fill="${CREAM}" fill-opacity="0.35"/>`,
  ...
  'Quarz': () => `${frameCircle()}<path d="M16 5 L24 14 L20 26 L12 26 L8 14Z" fill="#d8e0e8" fill-opacity="0.55" stroke="#a0b0c0" stroke-width="1"/><path d="M16 5 V26 M10 14 H22" stroke="${CREAM}" stroke-opacity="0.4" stroke-width="0.7"/>`,
  'Quarzader': () => `${frameCircle()}<ellipse cx="16" cy="16" rx="9" ry="8" fill="#5a5a62" fill-opacity="0.55" stroke="${STROKE}" stroke-width="0.9"/><path d="M8 20 Q14 10 18 14 Q22 18 25 12" fill="none" stroke="${CREAM}" stroke-width="1.4" stroke-linecap="round"/><path d="M10 12 Q16 16 22 10" fill="none" stroke="${CREAM}" stroke-opacity="0.35" stroke-width="0.7"/>`,
  'Klarer Quarz': () => `${frameCircle()}<path d="M16 4 L25 13 L21 27 L11 27 L7 13Z" fill="#e8f0f8" fill-opacity="0.4" stroke="#b0c0d0" stroke-width="1"/><path d="M16 4 V27 M9 13 H23" stroke="${CREAM}" stroke-opacity="0.45" stroke-width="0.7"/>`,
  ...
  'Glasbruch (sicher)': () => `${frameCircle()}<path d="M10 8 L16 12 L14 24Z" fill="#a8c8d8" fill-opacity="0.55" stroke="#6a8a9a" stroke-width="0.8"/><path d="M18 10 L24 16 L17 24Z" fill="#c0d8e0" fill-opacity="0.5" stroke="#6a8a9a" stroke-width="0.8"/>`,

  // Tools
  'Kreide': () => chalk(),
  'Besen': () => broom(),
  'Becher': () => `${frameCircle()}<path d="M10 10 H22 L20 24 H12Z" fill="${CREAM}" fill-opacity="0.45" stroke="${GOLD}" stroke-width="1"/><ellipse cx="16" cy="10" rx="6" ry="2" fill="${GOLD}" fill-opacity="0.35" stroke="${GOLD}" stroke-width="0.8"/><path d="M22 12 Q26 16 22 20" fill="none" stroke="${GOLD}" stroke-width="1"/>`,
  'Faden': () => thread(),
  'Spiegel': () => mirror(),
  'Schale': () => bowl(),
  'Glocke': () => bell(),
  'Athame (Symbol)': () => knife(),
  'Beutel': () => `${frameCircle()}<path d="M10 12 Q10 8 16 8 Q22 8 22 12 L21 24 H11Z" fill="#8a6a3a" fill-opacity="0.65" stroke="#6a4a28" stroke-width="0.9"/><path d="M10 12 H22" stroke="${GOLD}" stroke-width="1"/><circle cx="16" cy="11" r="1.2" fill="${GOLD}" fill-opacity="0.5"/>`,
  ...
  'Feder / Stift': () => feather(),
  'Stift': () => `${frameCircle()}<path d="M12 24 L14 8 L18 8 L20 24Z" fill="#3a6aaa" fill-opacity="0.7" stroke="#2a4a7a" stroke-width="0.8"/><path d="M14 8 L16 4 L18 8" fill="#e8d060" fill-opacity="0.8"/><rect x="14" y="10" width="4" height="3" fill="${GOLD}" fill-opacity="0.4"/>`,
