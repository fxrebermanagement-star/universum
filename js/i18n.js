...
(function (global) {
  ...
  var DICT = {
    de: {
      ...
      'altar.mehr': 'Mehr am Altar',
      'altar.mehrHint': 'Pfad-Woche · Intention · 369',
      'altar.heute': 'Heute · Impuls',
      'altar.mond': 'Mond',
      'altar.sonne': 'Sonne',
      'altar.schumann': 'Schumann',
      'altar.sigille': 'Sigille',
      'altar.karten': 'Karten',
      'altar.pathWeek': 'Pfad-Woche',
      'altar.intention': 'Intention des Tages',
      'altar.praxis369': '369-Praxis · heute',
      'altar.trustLine': 'Vertrauen & Ethik',
      'altar.trustNote': 'Daten bleiben auf diesem Gerät',
      'altar.localChip': '● Lokal',
      'settings.haptics': 'Haptik (Vibration)',
      'settings.schumannLive': 'Live-Stationsdaten laden (Tomsk / NOAA via ResonanceOne)',
      'settings.schumannAudio': 'Schumann-Audio (leiser 136-Hz-Träger)',
      'settings.ambient': 'Sanfter Ambient-Ton (sehr leise, getrennt von Schumann)',
      'settings.ritualKlang': 'Ritual-Klang (leiser Ton beim Öffnen und Schließen, Standard aus)',
      'settings.reducedMotion': 'Reduzierte Bewegung',
      'settings.mondnacht': 'Mondnacht (sanftes Abendlicht)',
      'settings.mondnachtAuto': 'Mondnacht abends automatisch (ca. 19–6 Uhr)',
      'settings.hourAlert': 'Planetenstunde-Wecker (sanfte Vibration/Toast, Standard aus)',
      'settings.quietRitual': 'Chrome während Ritual ausblenden',
      'settings.stille': 'Stille-Modus (nur Heute und ein Ritual)',
      'settings.calPathOnly': 'Kalender: nur mein Pfad (Feste)',
    ...
    en: {
      ...
      'altar.mehr': 'More on the Altar',
      'altar.mehrHint': 'Path week · Intention · 369',
      'altar.heute': 'Today · Impulse',
      'altar.mond': 'Moon',
      'altar.sonne': 'Sun',
      'altar.schumann': 'Schumann',
      'altar.sigille': 'Sigils',
      'altar.karten': 'Cards',
      'altar.pathWeek': 'Path week',
      'altar.intention': 'Intention of the day',
      'altar.praxis369': '369 practice · today',
      'altar.trustLine': 'Trust & ethics',
      'altar.trustNote': 'Data stays on this device',
      'altar.localChip': '● Local',
      'settings.haptics': 'Haptics (vibration)',
      'settings.schumannLive': 'Load live station data (Tomsk / NOAA via ResonanceOne)',
      'settings.schumannAudio': 'Schumann audio (quiet 136 Hz carrier)',
      'settings.ambient': 'Soft ambient tone (very quiet, separate from Schumann)',
      'settings.ritualKlang': 'Ritual sound (quiet tone on open/close, off by default)',
      'settings.reducedMotion': 'Reduced motion',
      'settings.mondnacht': 'Moon night (soft evening light)',
      'settings.mondnachtAuto': 'Moon night automatically evenings (~7pm–6am)',
      'settings.hourAlert': 'Planetary hour alert (gentle vibrate/toast, off by default)',
      'settings.quietRitual': 'Hide chrome during ritual',
      'settings.stille': 'Quiet mode (Today + one ritual only)',
      'settings.calPathOnly': 'Calendar: my path only (festivals)',
      'toast.langDe': 'Sprache: Deutsch',
      'toast.langEn': 'Language: English'
    }
  };
