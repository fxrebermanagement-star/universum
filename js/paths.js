...
(function (global) {
  ...
  const CORRESPONDENCES = {
    ...
    santeria: {
      herbs: [
        ...
        { name: "Lavendel", description: "Ruhe-Symbol für den Raum — sanft, ethisch", ico: "🪻" },
    ...
    wicca: {
      ...
      tools: [
        ...
        { name: "Räucherschale", description: "Werkzeug: Duft im Kreis — Haltung", ico: "⚪" },
      ],
      links: [
    ...
    esoterik: {
      ...
      tools: [
        ...
        { name: "Räucherschale", description: "Werkzeug: Duft für den Raum", ico: "⚪" },
      ],
      links: [
  ...
  const LEXIKON_CORE = {
    herbs: [
      ...
      { name: "Melisse", description: "Sanfte Ruhe am Tisch — Duft-Symbol", ico: "🍈" },
      { name: "Johanniskraut", description: "Licht- und Sonnenwende-Symbol — Haltung", ico: "☀️" },
      { name: "Holunder", description: "Schwelle und Jahreskreis — Blüte oder Zweig als Gabe, respektvoll", ico: "🫐" },
      { name: "Brennnessel", description: "Kraft und Stand — Alltagsgrün als Anker", ico: "🌵" },
      ...
      { name: "Lindenblüte", description: "Sanftheit und Atem-Raum — Duft-Symbol", ico: "🌼" },
      ...
      { name: "Oregano", description: "Wärme und Alltagskraft — Herd-Symbol", ico: "🍕" },
      { name: "Petersilie", description: "Einfache Gabe und Grün am Tisch — Respekt im Haus.", ico: "🍩" },
      { name: "Frauenmantel", description: "Kreis und Behütung — Blatt als Symbol", ico: "🌂" },
      ...
      { name: "Baldrian", description: "Stille-Symbol für den Abend — Haltung", ico: "😴" },
    ...
    stones: [
      ...
      { name: "Karneol", description: "Wärme und Herdton — Funke als Symbol", ico: "🔶" },
