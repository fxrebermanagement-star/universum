...
(function (global) {
  ...
  const CORRESPONDENCES = {
    schamanismus: {
      ...
      stones: [
        ...
        { name: "Rauchquarz", description: "Altarstein für Klarheit im Raum — Haltung und Atem, kein Messversprechen.", ico: "🌫️" },
      ...
      colors: [
        ...
        { name: "Waldgrün", description: "Altarfarbe: Wachstum mit Maß — Blickfang für den Kreis, kein Heilversprechen.", ico: "🌲" },
      ...
      tools: [
        ...
        { name: "Besen", description: "Werkzeug: Raum kehren als Ordnung — Alltag ehren, kein Reinigungsversprechen am Körper.", ico: "🧹" },
      ...
      links: [
        ...
        { name: "Wachs", description: "Bezug / Hilfsmittel: Kerzenwachs formen oder versiegeln — Absicht sichtbar machen, ohne Schaden zu wollen. Wald- und Schwellen-Ton: Körper zuerst, keine Geister fordern.", ico: "🕯️" },
        { name: "Asche", description: "Bezug / Hilfsmittel: Asche als Rest und Abschluss — was verbrannt/beendet ist; Symbol für Loslassen, kein Angriff. Wald- und Schwellen-Ton: Körper zuerst, keine Geister fordern.", ico: "🖤" },
    ...
    nordisch: {
      herbs: [
        ...
        { name: "Thymian", description: "Haus und Herd — kleine Gabe auf dem Tisch, Alltag ehren statt Pathos.", ico: "🌿" },
      ...
      stones: [
        ...
        { name: "Granit", description: "Schwerer Stand-Stein — Maß ohne Prahlerei.", ico: "🪨" },
        { name: "Kiesel vom Weg", description: "Alltags-Blickfang: klar gehen, nichts erzwingen.", ico: "🪨" },
        { name: "Eisengrau-Stein", description: "Grenze und Frith — kühler Merkstein, kein Amulettzwang.", ico: "🪨" },
        { name: "Quarzader", description: "Heller Schnitt im Gestein — Klarheit des Worts als Symbol.", ico: "💎" },
      ],
      colors: [
        ...
        { name: "Knochenweiß", description: "Altarfarbe: schlichte Reinheit als Symbol, kein Reinigungsversprechen.", ico: "⬜" },
        { name: "Blutrot (mit Maß)", description: "Kerze nur mit Ethik — Kraft-Symbol, nie gegen den Willen anderer.", ico: "🔴" },
      ],
      tools: [
      ...
      links: [
        ...
        { name: "Wachs", description: "Bezug / Hilfsmittel: Kerzenwachs formen oder versiegeln — Absicht sichtbar machen, ohne Schaden zu wollen. Ring- und Frith-Ton: Wort halten, Maß im Kreis.", ico: "🕯️" },
        { name: "Asche", description: "Bezug / Hilfsmittel: Asche als Rest und Abschluss — was verbrannt/beendet ist; Symbol für Loslassen, kein Angriff. Ring- und Frith-Ton: Wort halten, Maß im Kreis.", ico: "🖤" },
    ...
    voodoo: {
      ...
      stones: [
        ...
        { name: "Korallenstück (Symbol)", description: "Meer-Ton als Blickfang — Respekt, keine Initiation.", ico: "🪸" },
        { name: "Flusskiesel", description: "Schlichtes Merkzeichen für Fluss und Maß.", ico: "🪨" },
        { name: "Tonperle", description: "Hausgemachter Blickfang — Ordnung und Gabe, nicht Orakelzwang.", ico: "🟤" },
      ],
      colors: [
        { name: "Weiß", description: "Altarfarbe / Kerze: Reinheit-Symbol — Haltung, kein Reinigungsversprechen.", ico: "⬜" },
        { name: "Blau", description: "Altarfarbe: Ruhe und Wasser-Ton am Hof.", ico: "🔵" },
        { name: "Rot (mit Maß)", description: "Kerze: Kraft-Symbol — Ethik zuerst, nie fremden Willen binden.", ico: "🔴" },
      ...
      tools: [
        ...
        { name: "Schale", description: "Werkzeug: Opfergabe teilen — öffentliche Praxis nur.", ico: "🥣" },
      ],
      links: [
        ...
        { name: "Wachs", description: "Bezug / Hilfsmittel: Kerzenwachs formen oder versiegeln — Absicht sichtbar machen, ohne Schaden zu wollen. Hof-Ton: nur öffentliche Praxis, keine Initiation.", ico: "🕯️" },
        { name: "Asche", description: "Bezug / Hilfsmittel: Asche als Rest und Abschluss — was verbrannt/beendet ist; Symbol für Loslassen, kein Angriff. Hof-Ton: nur öffentliche Praxis, keine Initiation.", ico: "🖤" },
    ...
    santeria: {
      ...
      stones: [
        ...
        { name: "Muschelweiß", description: "Schlichter Wasser-Ton — Reinheit als Symbol, kein Reinigungsversprechen.", ico: "🐚" },
      ...
      tools: [
        ...
        { name: "Becher", description: "Werkzeug: Wasser und Reinheit-Symbol — Haltung, kein Reinigungsversprechen.", ico: "🏺" },
        ...
        { name: "Schale", description: "Werkzeug: Früchte und Dank ablegen — teilen statt fordern.", ico: "🥣" },
      ...
      links: [
        ...
        { name: "Wachs", description: "Bezug / Hilfsmittel: Kerzenwachs formen oder versiegeln — Absicht sichtbar machen, ohne Schaden zu wollen. Hausaltar-Ton: ohne Ile-Anspruch, Dank vor Forderung.", ico: "🕯️" },
        { name: "Asche", description: "Bezug / Hilfsmittel: Asche als Rest und Abschluss — was verbrannt/beendet ist; Symbol für Loslassen, kein Angriff. Hausaltar-Ton: ohne Ile-Anspruch, Dank vor Forderung.", ico: "🖤" },
    ...
    hermetik: {
      herbs: [
        ...
        { name: "Lorbeer", description: "Sieg nur als Klarheit der Frage — Beobachtung vor Eingriff.", ico: "🍃" },
      ...
      colors: [
        { name: "Königsblau", description: "Altarfarbe / Tuch: Denken und Maß.", ico: "🔵" },
      ...
      tools: [
        ...
        { name: "Feder / Stift", description: "Werkzeug: Protokoll — Absicht knapper halten.", ico: "🪶" },
        { name: "Waage (Symbol)", description: "Werkzeug: Ausgleich prüfen — Ethik vor Spektakel.", ico: "⚖️" },
        { name: "Schale", description: "Werkzeug: Stoffe trennen und ordnen — Laborhaltung.", ico: "🥣" },
      ],
      links: [
        ...
        { name: "Wachs", description: "Bezug / Hilfsmittel: Kerzenwachs formen oder versiegeln — Absicht sichtbar machen, ohne Schaden zu wollen. Labor-Ton: beobachten, protokollieren, Ethik vor Eingriff.", ico: "🕯️" },
        { name: "Asche", description: "Bezug / Hilfsmittel: Asche als Rest und Abschluss — was verbrannt/beendet ist; Symbol für Loslassen, kein Angriff. Labor-Ton: beobachten, protokollieren, Ethik vor Eingriff.", ico: "🖤" },
    ...
    wicca: {
      herbs: [
        ...
        { name: "Lavendel", description: "Sanfte Reinigung und Ruhe im Raum — Duft und Absicht, kein Heilversprechen.", ico: "💜" },
        ...
        { name: "Thymian", description: "Mut und Hauskraft als Symbol — kleine Gabe, Alltag ehren.", ico: "🌿" },
        { name: "Eisenkraut", description: "Klassisches Schutz- und Schwellenkraut in der Hexerei — Haltung, nicht Rezept.", ico: "🌿" },
        { name: "Kamille", description: "Sanfter Frieden im Raum — Tee oder Duft als Symbol, keine medizinischen Claims.", ico: "🌼" },
      ...
      stones: [
        ...
        { name: "Moosachat", description: "Erde / Ankern — Stand nach dem Kreis.", ico: "💚" },
      ...
      colors: [
        ...
        { name: "Grün", description: "Altarfarbe: Wachstum mit Maß.", ico: "🟢" },
        { name: "Weiß", description: "Altarfarbe / Kerze: Klarheit im Kreis.", ico: "⬜" },
      ...
      tools: [
        ...
        { name: "Räucherschale", description: "Werkzeug: Duft im Kreis — Haltung, kein Heilversprechen.", ico: "💨" },
      ],
      links: [
        ...
        { name: "Wachs", description: "Bezug / Hilfsmittel: Kerzenwachs formen oder versiegeln — Absicht sichtbar machen, ohne Schaden zu wollen. Kreis-Ton: an niemandem Schaden, Einwilligung achten.", ico: "🕯️" },
        { name: "Asche", description: "Bezug / Hilfsmittel: Asche als Rest und Abschluss — was verbrannt/beendet ist; Symbol für Loslassen, kein Angriff. Kreis-Ton: an niemandem Schaden, Einwilligung achten.", ico: "🖤" },
    ...
    chaosmagie: {
      herbs: [
        ...
        { name: "Thymian", description: "Alltags-Anker nach dem Labor — kleine Praxis statt Identitätsdrama.", ico: "🌿" },
      ...
      stones: [
        ...
        { name: "Klarer Quarz", description: "Leinwand-Stein — Absicht knapper halten.", ico: "💎" },
      ...
      colors: [
        ...
        { name: "Elektrisches Blau", description: "Labor-Akzent: Wachheit ohne Drama.", ico: "💠" },
      ],
      tools: [
      ...
      links: [
        ...
        { name: "Wachs", description: "Bezug / Hilfsmittel: Kerzenwachs formen oder versiegeln — Absicht sichtbar machen, ohne Schaden zu wollen. Labor/Banishing-Ton: Modell wählen, Ergebnis nicht jagen, Ethik Pflicht.", ico: "🕯️" },
        { name: "Asche", description: "Bezug / Hilfsmittel: Asche als Rest und Abschluss — was verbrannt/beendet ist; Symbol für Loslassen, kein Angriff. Labor/Banishing-Ton: Modell wählen, Ergebnis nicht jagen, Ethik Pflicht.", ico: "🖤" },
    ...
    esoterik: {
      herbs: [
        { name: "Lavendel", description: "Ruhe und sanfte Reinigung — Duft für den Raum, kein Heilversprechen.", ico: "💜" },
      ...
      stones: [
        ...
        { name: "Raucherquarz", description: "Weiches Klarheits-Symbol — Raum und Atem.", ico: "🌫️" },
      ...
      tools: [
        ...
        { name: "Besen", description: "Werkzeug: Raum kehren — Alltagspraxis.", ico: "🧹" },
        { name: "Schale", description: "Werkzeug: Gabe ablegen — teilen statt fordern.", ico: "🥣" },
        { name: "Räucherschale", description: "Werkzeug: Duft für den Raum — kein Heilversprechen.", ico: "💨" },
      ],
      links: [
        ...
        { name: "Wachs", description: "Bezug / Hilfsmittel: Kerzenwachs formen oder versiegeln — Absicht sichtbar machen, ohne Schaden zu wollen. Sanfter Alltagston: Absicht klein, kein Medium.", ico: "🕯️" },
        { name: "Asche", description: "Bezug / Hilfsmittel: Asche als Rest und Abschluss — was verbrannt/beendet ist; Symbol für Loslassen, kein Angriff. Sanfter Alltagston: Absicht klein, kein Medium.", ico: "🖤" },
  ...
  function normalizeNamedItem(item, kind) {
    ...
    if (item && typeof item === 'object') {
      ...
      if (item.ico) out.ico = String(item.ico);
      return out;
    }
